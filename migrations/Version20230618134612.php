 ...
 */
final class Version20230618134612 extends AbstractMigration
{
    ...
    public function up(Schema $schema): void
    {
        ...
        $this->addSql('ALTER TABLE feed_article ADD CONSTRAINT FK_B8281A1312469DE2 FOREIGN KEY (category_id) REFERENCES category (id)');
